...
- (void)setBeginAnimation:(void (^)(WBGameItem *sv, void (^complish)(BOOL)))BeginAnimation;

///过程动作
@property (copy) void(^LifecircleMotion)(WBGameItem *sv,NSInteger time,void(^complish)(BOOL complish));
- (void)setLifecircleMotion:(void (^)(WBGameItem *sv, NSInteger time, void (^complish)(BOOL)))LifecircleMotion;
///触发动画
@property (copy) void(^triggerAnimation)(WBGameItem *sv,void(^complish)(BOOL complish));
- (void)setTriggerAnimation:(void (^)(WBGameItem *sv, void (^complish)(BOOL)))triggerAnimation;
///结束动画
@property (copy) void(^EndAnimation)(WBGameItem *sv,void(^complish)(BOOL complish));
- (void)setEndAnimation:(void (^)(WBGameItem *sv, void (^complish)(BOOL)))EndAnimation;
